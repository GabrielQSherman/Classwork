let movieRental = {
    ...
    transferMovie() {
        ...
        let selectElement = this,
            ...
            choosenMovie = selectElement.value;

        // console.log(choosenMovie);

        movieRental.allMovies.forEach( obj => {

            if (obj.title == choosenMovie) {
                
                console.log(choosenMovie);

                obj.available = obj.available == true ? false : true;
        ...
        let sideBar = document.getElementById('sideBar'),
            rentDiv = document.getElementById('rDiv'),
            avlDiv = document.getElementById('aDiv');
