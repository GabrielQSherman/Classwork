        ...
        rl.question("Would you like to add a property to your object(y/n)\nInput: ", (yon) => {
            ...
            if (yon === 'y' || yon === '') {
                ...
                function add_property() {
                    ...
                    rl.question("What name would you like to give this property?\nInput: ", (propName) => {

                        propName = propName.trim();
                        

                        rl.question("What type of primitive variable type would you like your property to have?('string', 'number', or 'boolean')\nInput: ", (propValueType) => {
                            propValueType = propValueType.trim().toLowerCase().substring(0,1);

                            if (propValueType === 's' || propValueType === 'n' || propValueType === 'b') {
                            ...
                            rl.question("Now enter the value of this property\nInput: ", (propValue) => {
                                ...
                                rl.question("Would you like to create another object, go back to the main menu or add a property?(create/menu/prop)\nInput: ", (answer) => {
